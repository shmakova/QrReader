 ...
 */
package ru.shmakova.qr.presentation.camera;
...
public class CameraSource {
    ...
    private Camera createCamera() {
        ...
        SizePair sizePair = selectSizePair(camera, requestedPreviewWidth, mRequestedPreviewHeight);
        if (sizePair == null) {
        ...
        if (flashMode != null) {
            if (parameters.getSupportedFlashModes() != null) {
                if (parameters.getSupportedFlashModes().contains(
                    ...
                    Timber.i("Camera flash mode: " + flashMode + " is not supported on this device.");
                }
            }
        }
